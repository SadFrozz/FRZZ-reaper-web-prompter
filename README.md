...
**Q:** У меня не работает встроенный режим в Windows 7\8.X\10  
**A:** Проверьте наличие установленного MS Edge WebView2 Runtime, в Windows 7\8.X, а также ранних версиях Windows 10 данный компонент не встроен в систему и его нужно установить отдельно с сайта Microsoft [developer.microsoft.com](https://developer.microsoft.com/en-us/microsoft-edge/webview2)

...
- Автоскролл переработан: построчный режим использует адаптивную плавность, постраничный — динамическую длительность, добавлен порог срабатывания для мягкой подготовки следующей строки.

...
- Логика подсветок восстановлена до продакшн-варианта: управление классами `previous-line`, `pause-highlight` и `current-line` синхронизировано с новыми настройками.
...
### Исправлено
- Исправлено определение доступности Web Remote.
